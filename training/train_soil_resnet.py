...
MODEL_PATH = MODELS_DIR / "soil_resnet_updated_model.pth"
ENCODER_PATH = MODELS_DIR / "soil_label_encoder_7class.pkl"
METRICS_PATH = MODELS_DIR / "soil_resnet_updated_model_metrics.json"
RANDOM_STATE = 42
...
def main() -> None:
    ...
    print(f"Starting transfer learning for {args.epochs} epochs...")
    best_val_acc = 0.0
    best_epoch = 0
